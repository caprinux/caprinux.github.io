...
summary: PIE binary, Return 2 LIBC
---

This writeup will be more PwnTools-oriented since this writeup will also be cross-posted onto [Pwntools Blog](https://blog.pwntools.com).
