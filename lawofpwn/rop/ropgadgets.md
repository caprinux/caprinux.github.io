---
layout: post
title: ROP Gadgets and One Gadget
permalink: /lawofpwn/rop/ropgadgets
---
...
In order to win, we have to call `win(0xdeadbeef)`. In fact, from our chapter on [How does Assembly work and introduction to the Stack.](/lawofpwn/innerworkings/how_does_assembly_work), we know that we want to put `0xdeadbeef` into `rdi` since it's the first argument of the function.
